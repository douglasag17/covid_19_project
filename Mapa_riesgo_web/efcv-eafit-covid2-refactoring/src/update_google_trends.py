...
if __name__ == "__main__":
    ...
    get_trends_colombia(pytrend, kw_list, current_date, "data/google_trends_colombia.csv")
    get_trends_departments(pytrend, kw_list, current_date, "data/google_trends_departamentos.csv")
